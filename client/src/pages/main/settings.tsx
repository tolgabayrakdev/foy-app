...
export default function Settings() {
    ...
    const userForm = useForm({
        ...
        validate: {
            ...
            fullName: (value) => (value.length < 2 ? 'İsim en az 2 karakter olmalıdır' : null),
        },
    });
    ...
    const passwordForm = useForm({
        ...
        validate: {
            currentPassword: (value) => (value.length < 6 ? 'Şifre en az 6 karakter olmalıdır' : null),
    ...
    return (
        <Box p="md">
            ...
            <Card withBorder>
                <Title order={3} mb="md">Şifre Değiştir</Title>
